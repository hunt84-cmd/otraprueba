...
@section('page-title', 'Crear Punto de Venta')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="bi bi-shop-window"></i> Crear Nuevo Punto de Venta
                </h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.sales-points.store') }}">
                    @csrf
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check"></i> Crear Punto de Venta
                        </button>
                    </div>
                </form>
            </div>
