            ...
            <div class="col-md-6 col-lg-4">
                <div class="login-card">
                    <div class="login-header p-4 text-center">
                        ...
                        <p class="mb-0 mt-2">Gestión de Almacenes y Puntos de Venta</p>
                    </div>
                    ...
                    <div class="p-4">
                        ...
                        <div class="text-center">
                            <small class="text-muted">
                                ...
                                Admin: admin@inventory.com<br>
                                Almacenero: almacenero1@inventory.com<br>
                                Punto: punto1@inventory.com<br>
