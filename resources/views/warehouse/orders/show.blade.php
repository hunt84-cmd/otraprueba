            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <form method="POST" action="{{ route('warehouse.orders.approve', $order) }}" style="display: inline;">
                            @csrf
            ...
            <div class="card-body">
                ...
                @if($order->type === 'warehouse_entry')
                    <div class="alert alert-info">
                        ...
                        Esta es una orden de entrada de productos al almacén.
                    </div>
                @elseif($order->type === 'warehouse_to_sales_point')
                    <div class="alert alert-primary">
                        <i class="bi bi-arrow-right"></i>
                        Esta es una orden de transferencia a punto de venta.
                    </div>
                @endif
            </div>
        </div>
...
<div class="modal fade" id="rejectModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('warehouse.orders.reject', $order) }}">
                @csrf
